...
focusStackOptionsToArgs FocusStackOptions{ _verbose = verbose
                                         , _cropping = cropping
                                         , _additionalParameters = additionalParameters
                                         , _output = output
                                         } = let
      verbosityOpt = ["--verbose" | verbose]
...
runFocusStack opts@FocusStackOptions{ _verbose = verbose
                                    , _cropping = cropping
                                    ,  _additionalParameters = additionalParameters
                                    ,  _imgs = imgs
                                    ,  _workdir = workdir
