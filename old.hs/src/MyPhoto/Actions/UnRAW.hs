...
options =
  [ Option
    ...
    Option
      ...
      ["wb", "whitebalanceImg"]
      ( ReqArg
          (\f opts -> opts {optWhitebalance = WBFromImage f})
          "FILE"
      )
...
help :: String
help =
  let header = "Usage: unraw [OPTION...] files..."
...
getDcrawArgs opts =
  let addVerbosityArgs :: Options -> ([String], [Img]) -> IO ([String], [Img])
